...
def main(session):
    ...
    motion_service.wbEnableEffectorControl("LArm", True)
    motion_service.wbEnableEffectorControl("RArm", True)
    # motion_service.wbEnableEffectorControl("Torso", True)
    ...
    axisMaskList = [AXIS_MASK_VEL, AXIS_MASK_VEL]
